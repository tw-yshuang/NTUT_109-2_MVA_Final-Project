...
def reshape_crop_img(crop_imgs):
...
def hog_find_encode(img_path):
    ...
    for num_row in num_rows:
        ...
        crop_imgs = reshape_crop_img(crop_imgs)
        total_crop_imgs.append(crop_imgs)
        total_crop_positions.append(crop_positions)

    return total_crop_imgs, total_crop_positions
...
if __name__ == "__main__":
    ...
    for num_img in range(df.shape[0]-1000, df.shape[0]):
        ...
        total_crop_imgs, positions = hog_find_encode(img_path)
